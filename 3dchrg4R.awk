#!/bin/bash -l
#==========================================================================
# 3dchrg4R.avg ### calculate avg charge in bins of volume for a moiety  ###
#              ### R is the SCMTR headgroup/heptapeptide atoms down to  ###
#              ### and including the nitrogen that splits for the tails ###
# parameters
...
END	\
        { fr=(386+22080+34440+wa*3+io0*2)*ch;
	  lf=fr+386;
