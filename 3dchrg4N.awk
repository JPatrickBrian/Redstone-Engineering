#!/bin/bash -l
#==========================================================================
# 3dchrg4N.avg ### calculate avg charge in bins of volume for a moiety  ###
#              ### N is the lipid choline group atoms and down ending   ###
#              ### before the first phosphate oxygen                    ###
# parameters
...
END	\
        { fr=386+(386+22080+34440+wa*3+io0*2)*ch;
	  lf=fr+22080;
